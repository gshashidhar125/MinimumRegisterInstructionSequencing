...
namespace llvm {
  ...
  public:
    ...
    enum Kind {
      ...
      // SequencingEdge  /// < MRIS Sequencing edge between SUnits.
    };
  ...
  public:
    ...
    SUnit(SDNode *node, unsigned nodenum)
      : Node(node), Instr(0), OrigNode(0), NodeNum(nodenum),
        ...
        CopyDstRC(NULL), CopySrcRC(NULL) {lineage = NULL;}
  ...
  public:
	...
	int Reg;
	SmallVector<SUnit *, 4> Nodes;
	SmallVector<Lineage *, 4> Neighbours;
	SUnit *StartNode;
	SUnit *EndNode;
    typedef SmallVector<SUnit *, 4>::iterator Nodes_iterator;
    typedef SmallVector<Lineage *, 4>::iterator Neighbours_iterator;

	Lineage(int LineageNum) {
		
		Id = LineageNum;
		NeighbourCount = 0;
	//	Nodes = NULL;
	}
	void setNode(SUnit *SU) {
  ...
  public:
	...
	std::vector<Lineage *> ListOfLineage;
